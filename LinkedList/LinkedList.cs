    ...
    public partial class LinkedList : Form
    {
       ...
       */
        ...
        private void Button3__Click(object sender, EventArgs e)
        {
            ...
            LinkedListNode<object> target2 = linkedList.FindLast("the");
            if (target2 == null)
            {
            }
            else
            {
                linkedList.AddAfter(target2, "lazy");
            }
        ...
        private void Button4__Click(object sender, EventArgs e)
        {
            ...
            while (linkedListNode != null)
            {
                ...
                else if ((string)linkedListNode.Value == "sadness")
                {
        ...
        private void Button5__Click(object sender, EventArgs e)
        {
            ...
            linkedList.AddBefore(linkedList.Find("Spain"), "rain");
            linkedList.AddBefore(linkedList.Find("rain"), "The");
            linkedList.AddAfter(linkedList.Find("falls"), "mainly");
        ...
        private void Button6__Click(object sender, EventArgs e)
        {
            ...
            // Your code here
            linkedListNode1 = anagram.Find("D");
            linkedListNode2 = anagram.Find("Y");

            anagram.Remove(linkedListNode1);
            anagram.AddAfter(anagram.Find("R"), linkedListNode1);
            anagram.Remove(linkedListNode2);
            anagram.AddAfter(anagram.Find("M"), linkedListNode2);
