...
namespace MyEditor
{
    public partial class Form1 : Form
    {
        public Form1(MyEditorParent myEditorParent)
        {
            ...
            myEditorParent.closeAllToolStripMenuItem1.Click += new EventHandler(CloseAllToolStripMenuItem1__Click);
        ...
        private void CloseAllToolStripMenuItem1__Click(object sender, EventArgs e)
        {
            this.Close();
        }
        ...
        private void Timer__Tick(object sender, EventArgs e)
        {
            ...
            if (this.toolStripProgressBar1.Value == 0)
            {
                ...
                string performance = "Congratulation! You typed " + Math.Round(this.richTextBox.TextLength / 30.0, 2) + " letters per second!";
