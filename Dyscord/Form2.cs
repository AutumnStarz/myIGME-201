...
namespace Dyscord
{
    ...
    public partial class DyscordForm : Form
    {
        ...
        private void UsersButton__Click(object obj, EventArgs e)
        {
        ...
        private void SendButton__Click(object obj, EventArgs e)
        {
        ...
        private void ExitButton__Click(object obj, EventArgs e)
        {
            listener.Close();
            thread.Abort();
        ...
        private void Form__FormClosing(object sender, FormClosedEventArgs e)
        {
            listener.Close();
            thread.Abort();
        }
